                  ...
                  <div className="space-y-3">
                    <div className="border-l-4 border-blue-500 pl-4 py-3 bg-blue-50 rounded-r-lg">
                      ...
                      <p className="text-sm text-gray-700 mb-2">
                        Phân tích chiến tranh biên giới làm trầm trọng khủng hoảng kinh tế
                      </p>
                      <a 
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Xung đột 1977-1978, lật đổ Pol Pot. Quân số 150k-200k, luân phiên ~500k. Thương vong ~15,000.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> 17/2-16/3/1979: 200k quân TQ vs 70k-100k VN + 150k dân quân. Thương vong 20k-35k mỗi bên.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        Wikipedia. (n.d.). <em>Sino-Vietnamese conflicts (1979-1991)</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> ~3,750 vụ xung đột 1979-1982. Trận Vị Xuyên: 4,000 VN tử vong, 9,000 bị thương.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        Hoover Institution. (n.d.). <em>The 1979 Sino-Vietnamese War and Its Consequences</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Chi tiết chiến tranh 1979, áp lực thúc đẩy Đổi Mới 1986.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        GlobalSecurity.org. (n.d.). <em>Cambodia - Vietnamese Occupation 1979-1989</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Duy trì 180,000 quân, cao điểm 200,000. Tổng luân phiên ~500,000.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Chi tiêu quốc phòng ~20% GDP (1979-1985).
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> 25/12/1978: 150,000 quân xâm lược. 07/01/1979: Giải phóng Phnom Penh.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        Russia Beyond. (2016). <em>How Russian aid helped rebuild post-war Vietnam</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> 80-90% phụ thuộc viện trợ Liên Xô, ~1-3 tỷ USD/năm (1979-1985).
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        New York Times. (1979). <em>UN Assembly bids Vietnamese forces evacuate Cambodia</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Cấm vận phương Tây/ASEAN sau xâm lược Campuchia.
                      </p>
                      <a 
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        New York Times. (1979). <em>Sweden tells Vietnam to quit Cambodia or it may withdraw aid</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Thụy Điển đình chỉ viện trợ 1979, Nhật Bản chặn ODA.
                      </p>
                      <a 
