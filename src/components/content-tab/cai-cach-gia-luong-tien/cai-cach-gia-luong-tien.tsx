          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="bg-red-50 rounded-lg p-6 border-l-4 border-red-600 mb-8">
                <p className="text-gray-800 leading-relaxed mb-4">
                  Tháng <strong>9/1985</strong>, Bộ Chính trị quyết định thực
                  hiện cải cách "giá-lương-tiền" với hy vọng khắc phục tình
                  trạng khan hiếm hàng hóa và lạm phát ẩn. Nhưng do thiếu hiểu
                  biết về kinh tế thị trường, cải cách đã{" "}
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                  ...
                  <p className="text-gray-700 text-sm mb-2">
                    Tăng giá trung bình <strong>4-6 lần</strong>: gạo ~10 lần,
                    thực phẩm ~3-5 lần
                  </p>
                ...
                <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                  ...
                  <p className="text-gray-700 text-sm mb-2">
                    Lương danh nghĩa tăng <strong>~2-3 lần</strong>, nhưng giá
                    trị thực giảm{" "}
                    <strong className="text-red-600">60-70%</strong>
                  </p>
                ...
                <div className="bg-purple-50 rounded-lg p-6 border border-purple-200">
                  ...
                  <p className="text-gray-700 text-sm mb-2">
                    In tiền tăng <strong>~500-600%</strong> (M1) trong 12 tháng
                    để trả lương, bù đắp thâm hụt
                  </p>
              ...
              <div className="bg-red-100 rounded-lg p-6 border-2 border-red-300">
                ...
                <ul className="space-y-2 text-gray-800">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <strong>Lương tăng chậm hơn giá:</strong> Đời sống người
                      lao động giảm mạnh
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-red-600">774.7%</strong> trong 12
                      tháng sau cải cách (9/1985 - 9/1986)
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <XCircle className="w-6 h-6 text-red-600 shrink-0" />
                    <span>
                      <strong>Khan hiếm trầm trọng hơn:</strong> Hàng hóa biến
                      mất khỏi thị trường, chợ đen phát triển
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <XCircle className="w-6 h-6 text-red-600 shrink-0" />
                    <span>
                      <strong>Mất niềm tin:</strong> Người dân hoang mang, mất
                      lòng tin vào Nhà nước
                    </span>
                  </li>
                </ul>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          onClick={() =>
                            setExpandedYear(
                              expandedYear === data.year ? null : data.year
                            )
                          }
                        >
                          <div
                        ...
                        <div
                          className={`mt-4 text-center ${
                            isShock
                              ? "font-black text-red-600 text-lg"
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-red-500 pl-6 py-3">
                  ...
                  <p className="text-gray-700">
                    Lãnh đạo tưởng rằng chỉ cần{" "}
                    <strong>tăng giá + tăng lương</strong> là giải quyết được
                    vấn đề. Nhưng không hiểu rằng:{" "}
                ...
                <div className="border-l-4 border-orange-500 pl-6 py-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    <strong>không khuyến khích sản xuất</strong> → không tăng
                    được nguồn cung → tăng giá chỉ làm trầm trọng thêm khan
                    hiếm.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-amber-500 pl-6 py-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    →<strong className="text-red-600">lạm phát tăng vọt</strong>{" "}
                    → vòng xoáy ác tính.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-yellow-500 pl-6 py-3">
                  ...
                  <p className="text-gray-700">
                    Cải cách được thực hiện <strong>đột ngột</strong>, không có
                    dự trữ hàng hóa, không có kế hoạch ổn định thị trường → gây{" "}
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1">
                          <span className="text-amber-600">[CQ7.2]</span> Tư duy
                          Giáo điều - Cơ chế Bao cấp
                        </h4>
                        <p className="text-gray-700 text-sm">
                          Áp dụng máy móc mô hình kế hoạch hóa tập trung, phủ
                          nhận quy luật thị trường, dẫn đến nền kinh tế kém hiệu
                          quả, khan hiếm hàng hóa
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1">
                          <span className="text-orange-600">[CQ7.3]</span> Chiến
                          tranh Biên giới
                        </h4>
                        <p className="text-gray-700 text-sm">
                          Khuếch đại khủng hoảng nội tại: lấy đi nguồn lực khan
                          hiếm, cô lập quốc tế, đẩy nền kinh tế vào tình trạng
                          nguy kịch
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 text-sm">
                          Nỗ lực cuối cùng để cứu vãn cơ chế bao cấp → thất bại
                          thảm hại → lạm phát 774% → đỉnh cao của khủng hoảng
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 text-sm">
                          Thất bại toàn diện khiến Đảng thừa nhận: cơ chế bao
                          cấp không còn đường sống →
                ...
                <div className="bg-red-600 text-white rounded-lg p-6">
                  ...
                  <p className="leading-relaxed">
                    Cải cách giá-lương-tiền 1985 không chỉ là một chính sách
                    thất bại, mà chính là
                    <strong>"cái giá phải trả"</strong> cho tư duy giáo điều,
                    cứng nhắc trong quản lý kinh tế. Nó chứng minh rằng:{" "}
                    <strong>Không thể duy trì cơ chế bao cấp</strong> trong điều
                    kiện Việt Nam. Đây chính là{" "}
                    <strong>yếu tố thúc đẩy trực tiếp, bắt buộc</strong> Đảng
                    phải tiến hành Đổi Mới - một bước ngoặt lịch sử của dân tộc.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-8 border-2 border-green-300">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Sau cú sốc giá-lương-tiền, tình hình kinh tế-xã hội xuống đến
                  đáy. Các phiên họp Bộ Chính trị diễn ra gay gắt, tranh luận về
                  tương lai đất nước (→{" "}
                  <strong>Phiên họp Mất ngủ tháng 10/1985</strong>).
                </p>
                <p>
                  Tháng 12/1986,{" "}
                  <strong className="text-green-600">
                ...
                <ul className="space-y-2 ml-6">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0 mt-0.5" />
                    <span>
                      Thừa nhận vai trò của{" "}
                      <strong>quy luật giá trị, cung-cầu</strong>
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0 mt-0.5" />
                    <span>
                      Khuyến khích{" "}
                      <strong>kinh tế tư nhân, kinh tế hộ gia đình</strong>
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0 mt-0.5" />
                ...
                <p className="text-green-600 font-semibold pt-4">
                  → Đổi Mới đã cứu Việt Nam khỏi khủng hoảng, mở ra thời kỳ phát
                  triển mới.
                </p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4 py-3 bg-blue-50 rounded-r-lg">
                      ...
                      <p className="text-sm text-gray-700 mb-2">
                        Thừa nhận thất bại và thừa nhận quy luật giá trị, cung
                        cầu
                      </p>
                      <a
                        href="https://tulieuvankien.dangcongsan.vn"
                    ...
                    <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
                      ...
                      <p className="text-sm text-gray-700 mb-2">
                        NXB Chính trị Quốc gia, 2001 - Ghi chép về phiên họp mất
                        ngủ tháng 10/1985
                      </p>
                      <a
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">
                        IMF. (1991).{" "}
                        <em>Vietnam: A Case Study in Economic Reform</em>
                      </h4>
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Tăng giá 400-600%, lương
                        +200-300%, M1 +587%.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> 1986: 774.7% (cao nhất lịch
                        sử). Dữ liệu chính thức.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Xác nhận 774.7% là đỉnh siêu
                        lạm phát.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Chi tiết cải cách: giá gạo
                        x10, lương tăng 2-3 lần.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Chuyển sang kinh tế thị
                        trường định hướng XHCN sau thất bại 1985.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Dân thành phố bỏ về quê do
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Cung không tăng → khan hiếm
                        trầm trọng.
                      </p>
                      <a
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4 py-4 bg-indigo-50 rounded-r-lg">
                      ...
                      <p className="text-xs text-gray-600 mb-2">
                        <strong>Nội dung:</strong> Khuyến khích kinh tế hộ gia
                        đình, mở cửa FDI sau Đổi Mới.
                      </p>
                      <a
